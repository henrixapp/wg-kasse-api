...
ActiveRecord::Schema.define(version: 20170412165048) do
  ...
  create_table "authors", force: :cascade do |t|
    ...
    t.index ["uid", "provider"], name: "index_authors_on_uid_and_provider", unique: true
  end
  ...
  create_table "billing_items", force: :cascade do |t|
    ...
    t.datetime "created_at",                         null: false
    t.datetime "updated_at",                         null: false
    t.index ["author_id"], name: "index_billing_items_on_author_id"
  end
